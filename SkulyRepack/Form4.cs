        ...
        public void button1_Click(object sender, EventArgs e)
        {
            if (button1.Text == "Start")
            {
                ...
                if ((procmysqld.Length != 0))
                {
                    ...
                    var command1 = "/C " + @"MySQL\bin\mysql -u root --password=root auth <" + @"MySQL\bin\AccountBackup\AuthDB.sql";
                    ...
                    var command2 = "/C " + @"MySQL\bin\mysql -u root --password=root characters <" + @"MySQL\bin\AccountBackup\CharactersDB.sql";
